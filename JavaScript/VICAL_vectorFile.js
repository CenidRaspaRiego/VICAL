/* COMMENTS ON THE APPLICATION
        ...
        change vector file id: "projects/calcium-verbena-328905/assets/Bate"
*/
 
 //if you want to use your own vector file (shapefile) 
 //you must change the code that is in quotes "projects/calcium-verbena-328905/assets/Bate" 
 //This causes the New and edit polygon options to be disabled.
 //
...
var Regresion=ui.Checkbox({label:'regression map',value: false,style: {color: '#dc7a55', width: '120px'}})
...
var downloadRM= ui.Panel({
      layout: ui.Panel.Layout.flow("horizontal"),
      style: {backgroundColor: "#eceaea", position: 'top-center',shown: true},
      widgets: [ui.Label('download lineal Regression map',{backgroundColor: "#eceaea", color: '#615b58',width: '270px'}), DownloadC3_Button]
  });
...
var proc = ui.Button('Calculate', Procesa, false, {margin: 'auto', padding: '5px', width: '115px', fontSize: '15px'});
var proc2 = ui.Button('New polygon', Nuevo, false, {margin: 'auto', padding: '5px', width: '115px', fontSize: '15px'});
var proc3 = ui.Button('Edit polygon', Edita, false, {margin: 'auto', padding: '5px', width: '115px', fontSize: '15px'});
    ...
    if (Re_Response===true) { 
        ...
        GrafIV = ui.Chart.image.series(RegresionValue.select([nombreInd, nombreRegresion]),filtered,ee.Reducer.mean(), 10)
            .setOptions({
              ...
              series:{
                    0: {targetAxisIndex: 1, curveType: 'function', pointSize: 4,lineWidth: 1, }, //Etapa (Derecho)
                    1: {targetAxisIndex: 0, curveType: 'function', pointSize: 4, lineWidth: 1}  // NDVI (Izquierdo)
                     },              
